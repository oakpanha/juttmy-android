...
JNIEXPORT jlong Java_com_b44t_messenger_DcContext_getLocationCPtr(JNIEnv *env, jobject obj, jint chat_id, jint contact_id, jlong timestamp_tick)
{
    return (jlong)dc_get_location(get_dc_context(env, obj), chat_id, contact_id, CTIMESTAMP(timestamp_tick));
}
