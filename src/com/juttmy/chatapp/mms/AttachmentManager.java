...
import com.juttmy.chatapp.MediaPreviewActivity;
...
import com.juttmy.chatapp.components.RemovableEditableMediaView;
import com.juttmy.chatapp.components.ThumbnailView;
...
import com.juttmy.chatapp.util.concurrent.ListenableFuture.Listener;
  ...
  public static void selectLocation(Activity activity, int chatId) {
    Permissions.PermissionsBuilder permissionsBuilder = Permissions.with(activity)
            ...
            .onAllGranted(() -> {
              ...
              intent.putExtra(MapsActivity.MOD_LOCATION, MapsActivity.PICK_LOCATION); //--to set mod pick or show location
