...
import com.juttmy.chatapp.ConversationListActivity;
import com.juttmy.chatapp.R;
import com.juttmy.chatapp.notifications.NotificationCenter;
...
public class KeepAliveService extends Service {
    ...
    public void onCreate() {
        Log.i("MyJuttmy", "*** KeepAliveService.onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i("MyJuttmy", "*** KeepAliveService.onStartCommand()");
        return START_STICKY;
    }
    ...
    public void onDestroy() {
        Log.i("MyJuttmy", "*** KeepAliveService.onDestroy()");
