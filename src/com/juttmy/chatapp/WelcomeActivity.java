...
import com.juttmy.chatapp.qr.RegistrationQrActivity;
import com.juttmy.chatapp.service.GenericForegroundService;
import com.juttmy.chatapp.service.NotificationController;
import com.juttmy.chatapp.util.views.ProgressDialog;

import java.io.File;
import java.io.IOException;

import static com.b44t.messenger.DcContext.DC_SHOW_EMAILS_ALL;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_SHOW_EMAILS;
...
public class WelcomeActivity extends BaseActionBarActivity implements DcEventCenter.DcEventDelegate {
    ...
    public boolean isInternetAvailable(){
      try {
        String command = "ping -c 1 juttmy.com";
    ...
    public void onCreate(Bundle bundle) {
        ...
        loginButton.setOnClickListener((view) -> startRegistrationActivity());  //--this is login form
        signupButton.setOnClickListener((view) -> startJuttmySignUpForm());
        ...
        //Customize preference here:
        dcContext.setConfigInt(CONFIG_SHOW_EMAILS, DC_SHOW_EMAILS_ALL);
    }
    ...
    private void startJuttmySignUpForm(){
      if(isInternetAvailable()){
        manualConfigure = true;
        Intent intent = new Intent(this, JuttmySignUpActivity.class);
        startActivity(intent);
      }else{
