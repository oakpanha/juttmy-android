...
import com.juttmy.chatapp.components.AudioView;
import com.juttmy.chatapp.components.AvatarImageView;
import com.juttmy.chatapp.components.ConversationItemFooter;
import com.juttmy.chatapp.components.ConversationItemThumbnail;
import com.juttmy.chatapp.components.DocumentView;
import com.juttmy.chatapp.components.QuoteView;
import com.juttmy.chatapp.connect.ApplicationDcContext;
import com.juttmy.chatapp.connect.DcHelper;
import com.juttmy.chatapp.location.MapsActivity;
import com.juttmy.chatapp.mms.AudioSlide;
import com.juttmy.chatapp.mms.DocumentSlide;
import com.juttmy.chatapp.mms.GlideApp;
import com.juttmy.chatapp.mms.GlideRequests;
import com.juttmy.chatapp.mms.Slide;
import com.juttmy.chatapp.mms.SlideClickListener;
import com.juttmy.chatapp.mms.SlideDeck;
import com.juttmy.chatapp.mms.VideoSlide;
import com.juttmy.chatapp.recipients.Recipient;
import com.juttmy.chatapp.util.LongClickCopySpan;
import com.juttmy.chatapp.util.LongClickMovementMethod;
    ...
    implements BindableConversationItem
{
  ...
  private boolean hasLocation(DcMsg dcMsg){
    return dcMsg.hasLocation();
  }
  ...
  private class PassthroughClickListener implements View.OnLongClickListener, View.OnClickListener {
    ...
    public void onClick(View v) {
      performClick();
      if(hasLocation(messageRecord)){
        int chatId = messageRecord.getChatId();
        int contactId = messageRecord.getFromId();
        long timestamp = messageRecord.getTimestamp();
        DcArray location = dcContext.getLocation(chatId, contactId, timestamp);
        Intent intent = new Intent(v.getContext(), MapsActivity.class);
        intent.putExtra(MapsActivity.CHAT_ID, chatId);
        intent.putExtra(MapsActivity.MOD_LOCATION, MapsActivity.SHOW_LOCATION); //--to set mod pick or show location
        intent.putExtra(MapsActivity.SET_COORDINATE,
          new double[]{
            location.getLatitude(0),
            location.getLongitude(0)
          });
        v.getContext().startActivity(intent);
        //Log.d("location", locations.getLatitude(0) + ":" + locations.getLongitude(0));
      }
    }
  }
