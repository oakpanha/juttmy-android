...
import com.juttmy.chatapp.util.task.ProgressDialogAsyncTask;
import com.juttmy.chatapp.util.views.ProgressDialog;

import java.lang.ref.WeakReference;
import java.util.concurrent.ExecutionException;

import static com.juttmy.chatapp.connect.DcHelper.CONFIG_ADDRESS;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_MAIL_PASSWORD;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_MAIL_PORT;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_MAIL_SECURITY;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_MAIL_SERVER;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_MAIL_USER;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_SEND_PASSWORD;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_SEND_PORT;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_SEND_SECURITY;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_SEND_SERVER;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_SEND_USER;
import static com.juttmy.chatapp.connect.DcHelper.CONFIG_SERVER_FLAGS;
import static com.juttmy.chatapp.connect.DcHelper.getContext;
...
public class RegistrationActivity extends BaseActionBarActivity implements DcEventCenter.DcEventDelegate {
    ...
    private final String mailextension = "@juttmy.com";
    ...
    public void onCreate(Bundle bundle) {
        ...
        String usname = getIntent().getStringExtra("putusr");
        if(usname != "") emailInput.setText(usname);
        ...
        //--for test
        emailInput.setText(R.string.test_usr);
        passwordInput.setText(R.string.test_pwd);
        onLogin();
    }
    ...
    private static class PrecheckOauth2AsyncTask extends ProgressDialogAsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String redirectUrl = "chatapp.juttmy:/"+BuildConfig.APPLICATION_ID+"/auth";
    ...
    private void updateProviderInfo() {
        ...
        provider = getContext(this).getProviderFromEmail(email);
        if (provider!=null) {
    ...
    private void maybeCleanProviderInfo() {
        if (provider!=null && providerLayout.getVisibility()==View.VISIBLE) {
            DcProvider newProvider = getContext(this).getProviderFromEmail(emailInput.getText().toString().toLowerCase());
            if (newProvider == null
    ...
    private void setConfig(@IdRes int viewId, String configTarget, boolean doTrim) {
        ...
        /*Allow JuttmyID*/
        if(configTarget == "addr"){
          if(!value.isEmpty() && !matchesEmailPattern(value)){
            value += mailextension;
          }
        }
        /*--------*/
