...
import com.juttmy.chatapp.profiles.AvatarHelper;
import com.juttmy.chatapp.profiles.ProfileMediaConstraints;
import com.juttmy.chatapp.util.BitmapDecodingException;
import com.juttmy.chatapp.util.BitmapUtil;
import com.juttmy.chatapp.util.DynamicLanguage;
import com.juttmy.chatapp.util.DynamicTheme;
import com.juttmy.chatapp.util.FileProviderUtil;
...
public class CreateProfileActivity extends BaseActionBarActivity implements EmojiKeyboardProvider.EmojiEventListener {
      ...
      case REQUEST_CODE_AVATAR:
        if (resultCode == Activity.RESULT_OK) {
          ...
          if (data != null && data.getBooleanExtra("delete", false)) {
            ...
            Crop.of(inputFile, outputFile).asSquare().start(this);
          }
        }
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("com.juttmy.chatapp.action.CLEAR_PROFILE_PHOTO"));
    }
