package com.juttmy.chatapp.video.recode;
  ...
  private boolean convertVideo(final VideoEditedInfo videoEditedInfo, String destPath) {
    ...
    if (resultWidth != 0 && resultHeight != 0) {
      ...
      try {
          ...
          if (videoIndex >= 0) {
            ...
            try {
              ...
              if (Build.VERSION.SDK_INT < 18) {
                ...
                //Log.i("MyJuttmy", "codec = " + codecInfo.getName() + " manufacturer = " + manufacturer + "device = " + Build.MODEL);
              } else {
                colorFormat = MediaCodecInfo.CodecCapabilities.COLOR_FormatSurface;
              }
              //Log.i("MyJuttmy", "colorFormat = " + colorFormat);
                ...
                while (decoderOutputAvailable || encoderOutputAvailable) {
                  ...
                  if (!decoderDone) {
                    ...
                    if (decoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                      ...
                      //Log.i("MyJuttmy", "newFormat = " + newFormat);
                      ...
                      if (startTime > 0 && videoTime == -1) {
                        if (info.presentationTimeUs < startTime) {
                          doRender = false;
                          //Log.i("MyJuttmy", "drop frame startTime = " + startTime + " present time = " + info.presentationTimeUs);
                        } else {
                        ...
                        if (!errorWait) {
                          if (Build.VERSION.SDK_INT >= 18) {
                            ...
                            if (inputBufIndex >= 0) {
                              ...
                              //Log.i("MyJuttmy", "input buffer not available");
                            }
                            */
                          }
                        }
                      ...
                      if ((info.flags & MediaCodec.BUFFER_FLAG_END_OF_STREAM) != 0) {
                        decoderOutputAvailable = false;
                        //Log.i("MyJuttmy", "decoder stream end");
                        if (Build.VERSION.SDK_INT >= 18) {
        ...
        //Log.i("MyJuttmy", "time = " + (System.currentTimeMillis() - time));
      }
    } else {
      //didWriteData(messageObject, cacheFile, true, true);
      return false;
