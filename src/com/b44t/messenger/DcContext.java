...
public class DcContext {
    ...
    public @NonNull DcArray    getLocation         (int chat_id, int contact_id, long timestamp_tick) { return new DcArray(getLocationCPtr(chat_id, contact_id, timestamp_tick)); }
    ...
    private native long getLocationCPtr (int chat_id, int contact_id, long timestamp_tick);
